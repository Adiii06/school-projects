...
# # <center> Hangman Part 1 (Three helper functions)
...
# 
# 
# **A. Determine whether the word has been guessed**
# 
# 
# 
...
# 
# 
# **C. Getting all available letters**
# 
# 
# 
...
if __name__ == "__main__":
    ...
    print(">>>secret_word = 'apple'")
    print(">>>letters_guessed = ['e', 'i', 'k', 'p', 'r', 's']")
    print(">>>print(is_word_guessed(secret_word, letters_guessed))")
    print(is_word_guessed(secret_word, letters_guessed), end='\n\n')

    print(">>>secret_word = 'apple'")
    print(">>>letters_guessed = ['e', 'i', 'k', 'p', 'r', 's']")
    print(">>>print(get_guessed_word(secret_word, letters_guessed)")
    print('\'' + get_guessed_word(secret_word, letters_guessed) + '\'', end='\n\n')

    print(">>>letters_guessed = ['e', 'i', 'k', 'p', 'r', 's']")
    print(">>>print(get_available_letters(letters_guessed)")
    print(get_available_letters(letters_guessed))
