...
# 
# 4.     The cost of the house that you are saving for is Php1M. 
# 
# 
# You are now going to try to find the best rate of savings to achieve a down payment on a Php1M house in 36 months. Since hitting this exactly is a challenge, we simply want your savings to be within Php100 of the required down payment. 
# 
# Write a program to calculate the best savings rate, as a function of your starting salary. You should use **bisection search** to help you do this efficiently. You should keep track of the number of steps it takes your bisections search to finish. You should be able to reuse some of the code you wrote for Laboratory Exercise 3 in this problem.
# 
...
# **Hints** 
# 
# ·      There may be multiple savings rates that yield a savings amount that is within Php100 of the required down payment on a Php1M house. In this case, you can just return any of the possible values. 
# 
...
print("\033[1mTest Case 1:\033[0m")
...
while abs(current_savings - total_cost * down_payment) >= 100:
    current_savings = 0
    base_salary = annual_salary
    current_rate = savings_rate / 10000

    for month in range(36):
        if month % 6 == 0 and month > 0:
            base_salary += base_salary * semi_annual_raise

        monthly_salary = base_salary / 12
        current_savings += monthly_salary * current_rate + current_savings * annual_return / 12

    if current_savings < total_cost * down_payment:
        low = savings_rate
    else:
        high = savings_rate
...
if bisection > 13:
    ...
    print("Best savings rate:", current_rate)
...
print("\033[1mTest Case 2:\033[0m")
...
print("\033[1mTest Case 3:\033[0m")
